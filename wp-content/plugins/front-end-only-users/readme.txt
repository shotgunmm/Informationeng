...
* UTF-8 support
* Front end features: registration, login, edit user profile, account management, user listings or searches, user profiles and more!
* Back end features: add new fields, add new users, create and assign user levels, email settings and options
...
* User Levels: Ability to create different user levels and to specify a default user level for users to be set to when they register (created on the “Levels” tab). Different level groups can have access to different content.
...
* Statistics: This feature allows you to gather information about users and how they are using your site, as well as to see what pages each user has visited.
