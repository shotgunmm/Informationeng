...
if ( ! function_exists( 'ABdevFW_post_meta_options' ) ){
	function ABdevFW_post_meta_options($post_id){  
		...
		<div class="post_meta_extras">
			<div>
				<small><?php _e('Here you can set other media to be shown instead of featured image.', 'ABdev_shard' ); ?></small>
			</div>
			<div>
				<label>
					<input type="radio" name="ABdevFW_selected_media" value="youtube" <?php checked($ABdevFW_selected_media, 'youtube') ?>> 
					<?php _e('Youtube Video ID:', 'ABdev_shard' ); ?>
			...
			<div>
				<label>
					...
					<?php _e('Vimeo Video ID:', 'ABdev_shard' ); ?>
			...
			<div>
				<label>
					...
					<?php _e('SoundCloud ID:', 'ABdev_shard' ); ?>
			...
			<div>
				<label>
					...
					<?php _e('None - Use Featured Image', 'ABdev_shard' ); ?>
				</label>
			</div>
		</div>   
		<?php  
