...
define( 'THEMENAME', 'Shard' );

require_once dirname( __FILE__ ) . '/class-tgm-plugin-activation.php';

add_action( 'tgmpa_register', 'shard_register_required_plugins' );

function shard_register_required_plugins() {
	...
	$plugins = array(
		array(
			...
			'version' 				=> '4.5.95', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
