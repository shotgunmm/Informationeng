...
function ABdevDND_tabs_dd_shortcode( $attributes, $content = null ) {
	...
	$return = '
		<div class="dnd-tabs dnd-tabs-'.$slide_direction.' dnd-tabs-position-'.$tabs_position.' '.$class.'" data-selected="'.$selected.'" data-break_point="'.$break_point.'" data-effect="'.$effect.'">
			<ul>
				'.$tabs_navigation.'
			</ul>
