...
$ABdevDND_shortcodes['service_box_dd'] = array(
	'attributes' => array(
		...
		'subtitle' => array(
			'description' => __('Subtitle', 'dnd-shortcodes'),
		),
		'icon' => array(
		...
		'type' => array(
			...
			'type' => 'select',
			'values' => array(
				'round' => __('Round', 'dnd-shortcodes'),
				'square' =>  __('Square', 'dnd-shortcodes'),
				'round_stroke' => __('Round Stroke', 'dnd-shortcodes'),
				'round_aside' => __('Round Aside', 'dnd-shortcodes'),
				'round_aside2' => __('Round Aside2', 'dnd-shortcodes'),
			),
		),
		'link' => array(
...
function ABdevDND_service_box_dd_shortcode( $attributes, $content = null ) {
	...
	$return = '
		<div class="dnd_service_box'.$class.'">
			...
			$return .= ($subtitle!='') ? '<span class="service_box_subtitle">'.$subtitle.'</span>' : '';
