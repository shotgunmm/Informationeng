...
<section class="clearfix <?php echo ($content != '') ? 'section_border_top' : '';?>">
	<div class="container">
		...
		if ($posts->have_posts()){
			while ($posts->have_posts()){
				...
				$out.= '<div class="portfolio_item portfolio_item_3' . $slugs . '">
					<div class="overlayed">
	...
	<?php 
		if(isset($shard_options['content_after_portfolio_column_3']) && $shard_options['content_after_portfolio_column_3']!=''){
			echo do_shortcode($shard_options['content_after_portfolio_column_3']);
		}
	?>
